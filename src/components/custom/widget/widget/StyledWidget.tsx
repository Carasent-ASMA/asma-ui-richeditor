import { ChevronDownIcon, ChevronUpIcon, StyledButton, StyledLink, StyledWidgetTitle } from 'asma-ui-richeditor'
...
export const StyledWidget: React.FC<PropsWithChildren<StyledWidgetProps>> = ({
    ...
    return (
        <div className={style['asma-ui-richeditor-styled-widget']}>
            <div
                className={clsx(
